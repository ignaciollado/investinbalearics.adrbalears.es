...
export class Convert {
  public static toCountries(json: string): CountriesDTO[] {
      return cast(JSON.parse(json), a(r("CountriesDTO")));
  }

  public static countriesToJson(value: CountriesDTO[]): string {
      return JSON.stringify(uncast(value, a(r("CountriesDTO"))), null, 2);
  }
}
